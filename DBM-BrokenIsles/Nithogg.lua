...
local specWarnCracklingJolt			= mod:NewSpecialWarningDodge(212841, nil, nil, nil, 1, 2, nil, nil, "watchstep")
local specWarnCracklingJoltNear		= mod:NewSpecialWarningClose(212841, nil, nil, nil, 1, 2, nil, nil, "watchstep")
local specWarnStaticCharge			= mod:NewSpecialWarningYou(212887, nil, nil, nil, 1, 2, nil, nil, "runout")
local specWarnLightningRod			= mod:NewSpecialWarningRun(212943, nil, nil, nil, 4, 2, nil, nil, "runaway")
local specWarnBreath				= mod:NewSpecialWarningDefensive(212852, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnBreathSwap			= mod:NewSpecialWarningTaunt(212852, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnStorm					= mod:NewSpecialWarningMove(212884, nil, nil, nil, 1, 2, nil, nil, "runaway")
