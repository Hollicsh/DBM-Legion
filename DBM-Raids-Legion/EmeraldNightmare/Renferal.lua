...
--Spider Form
local specWarnFeedingTime			= mod:NewSpecialWarningSwitchCount(212364, "-Healer", nil, nil, 1, 2, nil, nil, "killmob")
local specWarnVenomousPool			= mod:NewSpecialWarningMove(213124, nil, nil, nil, 1, 2, nil, nil, "runaway")
local specWarnWebWrap				= mod:NewSpecialWarningStack(212512, nil, 5, nil, nil, 1, 6, nil, nil, "stackhigh")
local specWarnNecroticVenom			= mod:NewSpecialWarningMoveAway(218831, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellNecroticVenom				= mod:NewFadesYell(218831)
local specWarnWebofPain				= mod:NewSpecialWarning("specWarnWebofPain", nil, nil, nil, 1, 2, nil, nil, nil, nil, "targetyou")
--Roc Form
local specWarnGatheringClouds		= mod:NewSpecialWarningSpell(212707, nil, nil, nil, 1, 2, nil, nil, "aesoon")
local specWarnDarkStorm				= mod:NewSpecialWarningMoveTo(210948, nil, nil, nil, 1, 2, nil, nil, "findshelter")
local specWarnTwistingShadows		= mod:NewSpecialWarningMoveAway(210864, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellTwistingShadows			= mod:NewFadesYell(210864)
local specWarnRazorWing				= mod:NewSpecialWarningDodge(210547, nil, nil, nil, 3, 2, nil, nil, "carefly")
local specWarnRakingTalon			= mod:NewSpecialWarningDefensive(215582, nil, nil, nil, 1, 2, nil, nil, "defensive")
local specWarnRakingTalonOther		= mod:NewSpecialWarningTaunt(215582, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
----Mythic
local specViolentWinds				= mod:NewSpecialWarningYou(218124, nil, nil, nil, 3, 2, nil, nil, "justrun")
